        ...
        <footer className="py-24 bg-[#f8fafc] text-slate-900 border-t border-slate-200">
          <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-16">
            <div className="col-span-2">
              <div className="h-16 w-auto mb-10 flex items-center gap-3">
                <img 
                ...
                />
                <h2 className="text-3xl font-syne font-bold uppercase tracking-tighter text-slate-900">Immigration<span className="text-primary italic">Law</span></h2>
              </div>
              <p className="text-slate-500 max-w-sm mb-10 leading-relaxed text-base font-light">
            ...
            <div>
              <h3 className="text-[10px] font-bold uppercase tracking-[0.3em] mb-10 text-primary">Navigation</h3>
              <ul className="space-y-5 text-slate-500 text-[11px] font-bold uppercase tracking-widest">
            ...
            <div>
              <h3 className="text-[10px] font-bold uppercase tracking-[0.3em] mb-10 text-primary">Global Offices</h3>

          ...
          <div className="p-8 md:p-12 space-y-10">
            ...
            {selectedVisa.hasPriority ? (
              <button
                ...
                className={`w-full p-8 rounded-3xl border flex items-center gap-6 group relative overflow-hidden ${isPriority ? 'bg-primary/5 border-primary shadow-[0_10px_30px_rgba(37,99,235,0.1)]' : 'bg-slate-50 border-slate-100 hover:border-slate-200'
                  }`}
              >
                <div className={`w-14 h-14 rounded-2xl flex items-center justify-center ${isPriority ? 'bg-primary text-white scale-110' : 'bg-slate-200 text-slate-500 group-hover:text-slate-700'
                  }`}>
